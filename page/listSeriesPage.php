...
<div class="body d-flex justify-content-between">
    ...
    onClick="return confirm ( \'Apakah ingin menambah series?\')">
    <i style="color: green" class="fa fa-thin fa-square-plus fa-3x"></i></a>
    </h4> 
</div>
<div class="col-md-4">
    </div>
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        <tr>
            ...
            <td>
                ...
                "onClick="return confirm ( \'Apakah ingin mengedit series?\')">
                <i style="color: navy" class="fa-sharp fa fa-pencil fa-2x"></i></a>
                <a href="../process/deleteSeriesProcess.php?id='.$data['id'].'
                "onClick="return confirm ( \'Apakah anda yakin ingin menghapus series ini?\')"> 
